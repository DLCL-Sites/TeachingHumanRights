...
<div id="wrap">
  ...
  <header id="header" class="container">
	...
	<?php global $user; ?> 
	<ul id="user-menu"> 
	<li><a class="button mobile-button" href="<?php print url('user'); ?>">
	<?php if($user->uid <> 0) { 
		print "My Account";
	} else {
		print "Login";
	...
	<?php if($user->uid <> 0):?> 
	<li><a class="button mobile-button" href="<?php print url('user/logout'); ?>">Logout</a></li> 
	<?php endif; ?> </ul>
      <!-- end header right -->
    </section>
    <!-- end header top -->
    ...
    <section id="main" class="<?php print $content_class; ?>">
      ...
      <?php if ($action_links): ?>
        <ul class="action-links">
          <?php 
		// Turn action links into buttons - MLW
		foreach ($action_links as $key => $link) {
   			$action_links[$key]['#link']['localized_options']['attributes'] = array('class' => array('button', 'button-mobile'));
		}
